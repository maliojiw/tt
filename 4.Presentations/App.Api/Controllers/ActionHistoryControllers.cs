...
{
    [Route("api/v{version:apiVersion}/ActionHistory")]
    [ApiVersion("1.0")]
    [ApiController]
    [Produces("application/json")]
    //[Authorize]
    [SwaggerTag("บริหารจัดการข้อมูล ActionHistory")]

    public class ActionHistoryController : BaseController
    {
        #region Private Variables
        private ILogger<ActionHistoryController> _logger;
        private IActionHistoryService _repository;
        ...
        public ActionHistoryController(
            ILogger<ActionHistoryController> logger, 
            IActionHistoryService repository, 
        ...
        /// <summary>
        /// ดึงข้อมูล ActionHistory โดย id
        /// </summary>
        /// <remarks>
        /// </remarks>
        ...
        [HttpGet("{id}")]
        [ProducesResponseType(typeof(ActionHistoryWithSelectionViewModel), 200)]
		...
		/// <summary>
        /// ดึงรายการเปล่าของ ActionHistory สำหรับการสร้างฟอร์มเปล่า
        /// </summary>
        /// <remarks>
        /// </remarks>
        ...
        /// <summary>
        /// ดึงข้อมูล ActionHistory โดยการค้นหา
        /// </summary>
        /// <remarks>
        /// </remarks>
        ...
        [ProducesResponseType(typeof(List<ActionHistoryViewModel>), 200)]
        [ProducesResponseType(401)]
        [ProducesResponseType(500)]
        //[ValidateAntiForgeryToken]
        public async Task<IActionResult> GetListBySearch([FromQuery]ActionHistorySearchModel model)
        {
            try
            {
        ...
        /// <response code="401">ไม่มีสิทธิในการใช้งาน</response>
        /// <response code="500">มีข้อผิดพลาดในการทำงานจากระบบ</response>  
        [HttpGet("ActionHistory_report")]
        [ProducesResponseType(typeof(FileStreamResult), 200)]
        [ProducesResponseType(401)]
        [ProducesResponseType(500)]
        //[ValidateAntiForgeryToken]
        public async Task<IActionResult> ActionHistory_report([FromQuery] ActionHistoryReportRequestModel model)
        {
            try
            {				
        ...
        [ProducesResponseType(500)]
        //[ValidateAntiForgeryToken]
        public async Task<IActionResult> Insert([FromBody] ActionHistoryInputModel model)
        {
        ...
        [ProducesResponseType(500)]
        //[ValidateAntiForgeryToken]
        public async Task<IActionResult> Update(Guid id, [FromBody] ActionHistoryInputModel model)
        {
            if (ModelState.IsValid)
            {
                try
		...
		/// <summary>
        /// ปรับปรุง ActionHistory ข้อมูลทีละหลายรายการ
        /// </summary>
        /// <remarks>
        /// </remarks>
        /// <param name="model"></param>
        ...
        [ProducesResponseType(500)]
        //[ValidateAntiForgeryToken]
        public async Task<IActionResult> UpdateMultiple([FromBody] List<ActionHistoryInputModel> model)
        {
            if (ModelState.IsValid)
            {
				try
